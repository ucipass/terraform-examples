...
def lambda_handler(event, context):
    ...
    palo2_eth1_id   = get_interface_id_by_tag("example9-dev-palo2-eth1", region)
    palo2_eth2_id   = get_interface_id_by_tag("example9-dev-palo2-eth2", region)
    eip_id1         = get_eip_id_by_tag("example9-dev-eip-ubuntu1", region)
    eip_id2         = get_eip_id_by_tag("example9-dev-eip-ubuntu2", region)
    cidr_block      = "0.0.0.0/0"
    palo2_eth1_ip1  = "10.100.21.101"
    palo2_eth1_ip2  = "10.100.21.102"
    
    delete_route(cidr_block, route_table_id1, region)
    delete_route(cidr_block, route_table_id2, region)

    add_route(cidr_block, palo2_eth2_id, route_table_id1, region)
    add_route(cidr_block, palo2_eth2_id, route_table_id2, region)
    associate_eip(eip_id1, region, palo2_eth1_id , palo2_eth1_ip1)
    associate_eip(eip_id2, region, palo2_eth1_id , palo2_eth1_ip2)
